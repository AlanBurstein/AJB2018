...
--==== 1. BASIC USE:
  -- 1.1. When b.I > 0  
  SELECT b.S1, b.S2, b.L1, b.L2, b.D, b.I, b.B, b.MS, b.S
  FROM samd.bernie8K('abc1234','bc123') b;
  
  -- 1.2. When b.I = 0
  SELECT b.S1, b.S2, b.L1, b.L2, b.D, b.I, b.B, b.MS, b.S
  FROM samd.bernie8K('abc123','xxx') b;

  -- 1.3. When @s1 and/or @s2 are blank or a space
  SELECT b.S1, b.S2, b.L1, b.L2, b.D, b.I, b.B, b.MS, b.S
  FROM samd.bernie8K('abc123','') b;

  -- 1.4. When @s1 and/or @s2 are blank are NULL
  SELECT b.S1, b.S2, b.L1, b.L2, b.D, b.I, b.B, b.MS, b.S
  FROM samd.bernie8K('abc123',NULL) b;

...
-- NOTE #1: The CASE statement only returns a value when @date is a valid date, otherwise 
...
-- NOTE #2: Uses AB forumula to return 0 & 1 as finite opposites:
-- WHEN LEN(dt.m)=2 I want 0, WHEN it's 1 I want 1

...
SET ANSI_NULLS ON
GO
CREATE VIEW [comdesk].[BAML_Export_OLD]
AS
...
FROM            emdbuser.LoanXRef AS lx INNER JOIN
                         ...
                         emdbuser.LOANXDB_S_09 AS ls09 ON lx.XRefID = ls09.XrefId
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "ln06"
            ...
            End
            DisplayFlags = 280
            TopColumn =', 'SCHEMA', N'comdesk', 'VIEW', N'BAML_Export_OLD', NULL, NULL
GO
EXEC sp_addextendedproperty N'MS_DiagramPane2', N' 0
   ...
   End
End
', 'SCHEMA', N'comdesk', 'VIEW', N'BAML_Export_OLD', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=2
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'comdesk', 'VIEW', N'BAML_Export_OLD', NULL, NULL
GO

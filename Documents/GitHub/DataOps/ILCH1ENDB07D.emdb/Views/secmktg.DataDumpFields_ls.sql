...
SET ANSI_NULLS ON
GO
CREATE VIEW [secmktg].[DataDumpFields_ls]
AS
SELECT        ls02._364, ls03._CX_FINALOCODE_4, ls10._CX_LOCODE_1, ls01._CX_PAIDLO_3, ls02._CX_PAIDLOCODE_3, ls01._11, ls02._12, ls01._14, ls03._15, ls01._36, 
                         ...
                         AS _CX_RESPAAPP_1, CONVERT(date, ld02._3142) AS _3142, ln07._CX_COPYLOBPS, ls05._CX_SECMI_16, ls03._CX_UWREQMI, ls02._2626, CONVERT(date, 
                         ld02._CX_BROKERFUND_5) AS _CX_BROKERFUND_5, CONVERT(date, ld02._CX_BROKERCLOSE_5) AS _CX_BROKERCLOSE_5, ls01._984, ln03._CX_CORPOBJ, 
                         ln06._CX_BPSDIFFER, ln06._CX_BPNETGAINLOSS, ls03._CX_NUMUWCONDITION, ls03._CX_UWNUMCNDOREVD, CONVERT(date, ld04.Log_MS_Date_Processing) 
                         AS Log_MS_Date_Processing, ls07._CX_LOANSERVICER, ls10.LoanTeamMember_Name_MortgageConsultant, ls01.LoanTeamMember_Name_LoanCoordinator, 
                         ls03._CX_MCNAME_1, ls01._CX_LCNAME_1, CONVERT(date, ld01._CX_APPSENT_1) AS _CX_APPSENT_1, CONVERT(date, ld01._CX_APPRCVD_1) 
                         AS _CX_APPRCVD_1, CONVERT(date, ld02.Log_MS_Date_UWDecisionExpected) AS Log_MS_Date_UWDecisionExpected, ln10._CX_UWC_COUNT_MC, ls01._1040, 
                         CONVERT(date, ld01._CX_SHPDATEASSIGN_1) AS _CX_SHPDATEASSIGN_1, ls15._3474, ln11._3475, ls15._3476, ln11._3477, ls15._3478, ln11._3479, ls10._2162, 
                         ls10._2164, ls10._2166, ls10._2168, ls10._2170, ls10._2172, ls10._2174, ls10._2176, ls10._2178, ls01._230, ln01._231, ln02._235, ln10._2163, ln10._2165, 
                         ln10._2167, ln10._2169, ln10._2171, ln10._2173, ln10._2175, ln10._2177, ln10._2179
FROM            emdbuser.LoanSummary AS ls INNER JOIN
                         emdbuser.LOANXDB_S_01 AS ls01 ON ls.XRefID = ls01.XrefId INNER JOIN
...
WHERE        (NOT (ls.LoanFolder IN ('Samples', '(Trash)')))
GO
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "ls06"
            ...
            End
            DisplayFlags = 280
            TopColumn =', 'SCHEMA', N'secmktg', 'VIEW', N'DataDumpFields_ls', NULL, NULL
GO
EXEC sp_addextendedproperty N'MS_DiagramPane2', N' 0
         ...
         Begin Table = "ld01"
            Begin Extent = 
               Top = 534
 ', 'SCHEMA', N'secmktg', 'VIEW', N'DataDumpFields_ls', NULL, NULL
GO
EXEC sp_addextendedproperty N'MS_DiagramPane3', N'              Left = 406
               Bottom = 663
               Right = 652
            End
            DisplayFlags = 280
...
DECLARE @xp int
SELECT @xp=3
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'secmktg', 'VIEW', N'DataDumpFields_ls', NULL, NULL
GO

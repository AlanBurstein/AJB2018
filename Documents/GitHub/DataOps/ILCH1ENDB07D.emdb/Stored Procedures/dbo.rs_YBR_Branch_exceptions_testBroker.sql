...
CREATE Procedure [dbo].[rs_YBR_Branch_exceptions_testBroker]
...
--   exec dbo.rs_YBR_Branch_exceptions_testdg 'dgorman', 'MC', 'Jennifer Larivee' ,'all'

...
create procedure [reports].[spGetTitleCompanyReportByCounty]
...
----------------------------------------------------------------------------------------------------------------------------------
	...
	sethm	02/13/13	added bcarrara to reports
...
begin
	...
	-- get the total units
	select @TotalLoanUnits = sum( LoanUnits ) from #CountyInfo
	
	-- and return the results
	select	case when CountyName = '' then 'Not Specified' else CountyName end as CountyName, LoanVolume, LoanUnits,

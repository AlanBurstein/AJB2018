...
create procedure [reports].[spGetTitleCompanyReportSummaryByTitle]
...
begin
	...
	select	isnull( T.TitleCompanyName, '(blank)' ) as TitleCompanyName, 
	...
	group	by isnull( T.TitleCompanyName, '(blank)' )

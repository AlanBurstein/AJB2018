...
CREATE procedure [reports].[spGetTitleCompanyReportSummaryByLoanOfficerAndTitleCompany]
...
----------------------------------------------------------------------------------------------------------------------------------
	...
	mava	01/02/15	added jmavalankar to report
*/
...
begin
	...
	select	E.EmployeeID, E.EmployeeName, isnull( T.TitleCompanyName, '(blank)' ) as TitleCompanyName,
	...
	group	by E.EmployeeID, E.EmployeeName, isnull( T.TitleCompanyName, '(blank)' )
	...
	select	EmployeeID, EmployeeName, TitleCompanyName, LoanVolume, LoanUnits,

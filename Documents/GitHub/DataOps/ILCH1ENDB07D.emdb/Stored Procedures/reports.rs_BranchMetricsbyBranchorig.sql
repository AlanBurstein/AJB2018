...
--   exec reports.rs_BranchMetricsbybranch  '2012-01-01', '2012-04-30', 1001

create Procedure [reports].[rs_BranchMetricsbyBranchorig]
...
(Case 
 ...
 case when (_2301 between @StartDate and @EndDate
				 ...
				 or _2987 between @StartDate and @EndDate) then  
		 _CX_NUMUWCONDITION else 0 end  as '#MC Conditions',				----1

case when (_2301 between @StartDate and @EndDate
				 or _2303  between @StartDate and @EndDate
				 or _2987 between @StartDate and @EndDate) and  
	_CX_NUMUWCONDITION < 1 then 0 	else 1
END as 'NumOfLoansMC_COND',

CASE
	when   (_2301 between @StartDate and @EndDate
				 or _2303  between @StartDate and @EndDate
				 or _2987 between @StartDate and @EndDate) and  _CX_PROBLOAN_5  = 'Y' then 1 
	else 0 
...
and
	...
	or _cx_funddate_1 between @StartDate and @EndDate)

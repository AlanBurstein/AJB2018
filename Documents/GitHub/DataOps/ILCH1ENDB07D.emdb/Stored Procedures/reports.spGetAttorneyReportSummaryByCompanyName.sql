...
create procedure [reports].[spGetAttorneyReportSummaryByCompanyName]
...
begin
	...
	select	case when _56 = '' then '(blank)' else _56 end as AttorneyCompanyName, 
	...
	group	by case when _56 = '' then '(blank)' else _56 end 
	...
	select	AttorneyCompanyName, LoanVolume, LoanUnits, ( LoanUnits + 0.0 ) / ( @TotalLoanUnits + 0.0 ) as PercentageOfTotal,

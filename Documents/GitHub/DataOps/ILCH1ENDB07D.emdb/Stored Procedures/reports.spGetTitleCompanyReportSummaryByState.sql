...
create procedure [reports].[spGetTitleCompanyReportSummaryByState]
...
begin
	...
	select	StateName, LoanVolume, LoanUnits, ( LoanUnits + 0.0 ) / ( @TotalLoanUnits + 0.0 ) as PercentageOfTotal,

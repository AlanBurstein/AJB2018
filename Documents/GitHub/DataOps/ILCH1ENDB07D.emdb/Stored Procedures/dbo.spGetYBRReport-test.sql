...
CREATE procedure [dbo].[spGetYBRReport-test]
...
CREATE TABLE #LoanInfoKeyTemp
(LoanInfoKey int)
	

IF @Options <> 'missingFromYBR'
BEGIN

INSERT INTO #LoanInfoKeyTemp
SELECT
...
and
	(
	fld.EstimatedClosingDate IS NULL
	OR
...
SELECT
    ...
    fld.CDSignedByAllDate,
    dli.UseNewLeCdGfeHud,    

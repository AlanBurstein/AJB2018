...
CREATE Procedure [dbo].[rs_BranchMetrics_test_vp]
...
Case 
 ...
 ---- Section 5  ---------------------- Quality  ------------------------------------
null as 'Count of Role: Mortgage Consultant',
 null as '#MC Conditions',				----1

null as 'NumOfLoansMC_COND',
null as '% of MC PROB files',						 -----2

null as 'LC: # Avg submission for approval',     -----3

null as '% UW Problem Files',        --------4

null as 'LC % Rush Closing', -- do count to get avg        -----5

null as 'LC % Problem Closing', -- do count to get avg    -----6
------------------------------------------------------------------------------------
 ------------------------------------------------------------------------------------
 --COUNTS
0 AS  totVP,
...
null  as 'Lock to Fund',
 ...
 ---- Section 5  ---------------------- Quality  ------------------------------------
CountRole  as 'Count of Role: Mortgage Consultant',
MCConditions  as '#MC Conditions',				----1

NumOfLoansMC_COND as 'NumOfLoansMC_COND',
percentMCPROBfiles as '% of MC PROB files',						 -----2

LCAvgsubmissionforapproval as 'LC: # Avg submission for approval',     -----3

percentUWProblemFiles as '% UW Problem Files',        --------4

LCRushClosing as 'LC % Rush Closing', -- do count to get avg        -----5

LCProblemClosing as 'LC % Problem Closing', -- do count to get avg    -----6
------------------------------------------------------------------------------------
 ------------------------------------------------------------------------------------
 --COUNTS
0 AS  totVP,
...
from
emdb.emdbuser.Loansummary ls
inner join emdb.reportrs.v_MCLC_metrics vm on vm.xrefid = ls.XRefID 
...
---where  _2301 between  @StartDate and @EndDate

--   exec emdb.dbo.rs_BranchMetrics_test_vp  '2012-06-01', '2012-06-30'

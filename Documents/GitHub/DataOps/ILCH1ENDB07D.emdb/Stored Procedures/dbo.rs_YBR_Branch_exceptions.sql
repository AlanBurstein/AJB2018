...
CREATE Procedure [dbo].[rs_YBR_Branch_exceptions]
...
--       exec dbo.rs_YBR_Branch_exceptions_testdg_VPPM 'tflavio', 'VP', 6088 ,'all'
...
----  exec dbo.rs_YBR_Branch_exceptions_testdg 'mcohn', 'MC', 'Dawn Flynn' ,'all'
...
--Was this: @UserName in (select SPLITVALUES from dbo.DelimitedListToVarcharTableVariable(dbo.allmanagers(dem.empid), ',')) --MGR
		...
		'ghafner', 'mward', 'KShattuck', 'ylopez', 'bhawley', 'jpugh', 'nejohnson', 'tgamache', 'jdowney') 
		)

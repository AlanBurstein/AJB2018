...
create procedure [reports].[spGetTitleCompanyReportSummaryByLoanOfficer]
...
begin
	...
	select	EmployeeID, EmployeeName, LoanVolume, LoanUnits, ( LoanUnits + 0.0 ) / ( @TotalLoanUnits + 0.0 ) as PercentageOfTotal,

...
create Procedure [dbo].[rs_BranchMetrics_orig]
...
--------- Groups ---------------------------------------------------------------
  ...
  cc.costcentername,
  --org.displayname,
  --org.officename,--- not needed now
  e.userlogin,
  e.firstname,
  e.lastname,
  ---loanfolder,  not needed now
  _CX_FINALOCODE_4 ,
  Case 
...
ls.LoanOfficerName,
LoanAmount,
CASE when LoanAmount < 1 then 0 else 1 end as LoanCount,
Case 
...
--------- Groups ---------------------------------------------------------------
 ...
 cc.costcentername,
 -- org.displayname,
  --null as officename,--- not needed now
  null as userlogin,
   null as firstname,
   null as lastname,
  ---loanfolder,  not needed now
   null as _CX_FINALOCODE_4 ,
...
--exec BranchMetrics  '2012-02-01', '2012-02-28'
